# macro_6: Structured event taxonomy audit
...
Make important facts publish through compact fixed-size event buffers instead of ad hoc logs.
...
Audit current event type coverage, add only generic types needed by multiple systems, preserve tag/data clamps, and test normalization/observer behavior.
