# macro_2: Content registry duplicate and reachability audit
...
Harden content registration so duplicate ids, missing labels, or invisible side-effect modules fail loudly.
...
- `src/gen/content_manifest_utils.ts`
...
Inspect all six content manifests, add readonly snapshot helpers only where needed, test duplicate Living zone labels/side quest ids, and do not recreate archived Docs prompt/status folders.
