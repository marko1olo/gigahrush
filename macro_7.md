# macro_7: Debug commands for verification routes
...
Expose reliable debug paths for new systems without leaking cheats into normal play.
...
Add or refine commands for contracts, events, floor route, lift anomalies, samosbor, economy, monsters, and containers using existing APIs and explicit debug-only gates.
