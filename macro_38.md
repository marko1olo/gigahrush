# macro_38: Resource shortage events and rumor hooks
...
Turn scarcity threshold changes into events, rumors, logs, and contract pressure.
...
Publish only on meaningful bands/recovery with cooldowns and compact resource/floor/zone/severity data.
