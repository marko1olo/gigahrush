...
/* ── Player actions ───────────────────────────────────────────── */
function handlePlayerRangedAttack(weaponId: string, ws: import('./data/weapons').WeaponStats, atkSpeedMod: number): void {
...
function handlePlayerMeleeAttack(weaponId: string, ws: import('./data/weapons').WeaponStats, atkSpeedMod: number): void {
...
function handlePlayerInteraction(): boolean {
