...
function enforceProjectileLimits(entityIndex: EntityIndex): void {
...
function processProjectileEntityCollisions(
  p: Entity,
  pt: ProjType,
...
function updateProjectiles(dt: number): void {
  ...
  enforceProjectileLimits(entityIndex);
  ...
  for (const p of entityIndex.projectiles) {
    ...
    processProjectileEntityCollisions(p, pt, entityIndex, prevX, prevY, wx, wy, prevSpriteZ, nextSpriteZ, blockingT);
