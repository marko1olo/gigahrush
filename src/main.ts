...
function handleNpcMenuInput(
  ...
  menuUpNav: () => boolean,
  menuDownNav: () => boolean,
  menuRepeatStep: (action: "up" | "down" | "left" | "right", held: boolean, edge: boolean) => boolean
): void {
  const npc = getEntityIndex().byId.get(state.npcMenuTarget) ?? entities.find(e => e.id === state.npcMenuTarget);
  if (state.npcMenuTab === 'main') {
...
function handleDebugMenuInput(closeEdge: boolean, upNav: boolean, dnNav: boolean, leftNav: boolean, rightNav: boolean, acceptEdge: boolean): void {
...
function handleFactionsMenuInput(upNav: boolean, dnNav: boolean): void {
...
function handleLogMenuInput(upNav: boolean, dnNav: boolean): void {
...
function handleCraftMenuInput(closeEdge: boolean, upNav: boolean, dnNav: boolean, acceptEdge: boolean): void {
  if (closeEdge) {
    closeCraftMenu();
    syncPauseState();
    updateMobileContext(true);
...
function handleMenuInput(): void {
  ...
  // ── Craft / disassembly menu navigation ──────────────────
    ...
    handleCraftMenuInput(closeEdge, menuUpNav(), menuDownNav(), acceptEdge);
  }
  // ── Quest log toggle ─────────────────────────────────────
  else if (state.showQuests) {
    handleQuestsMenuInput(menuUpNav(), menuDownNav(), acceptEdge);
  }
  ...
  // ── Faction relations menu ───────────────────────────────
    ...
    handleFactionsMenuInput(menuUpNav(), menuDownNav());
  }
  // ── Message log menu ─────────────────────────────────────
  else if (state.showLog) {
    handleLogMenuInput(menuUpNav(), menuDownNav());
  }
  // ── Full map menu ───────────────────────────────────────
