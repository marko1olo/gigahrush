...
class MobileControlsImpl implements MobileControls {
  ...
  private readonly movePad: HTMLButtonElement;
  private readonly moveThumb: HTMLSpanElement;
  private readonly lookPad: HTMLButtonElement;
  private readonly lookThumb: HTMLSpanElement;
  ...
  private readonly actionUp: HTMLButtonElement;
  private readonly actionSelect: HTMLButtonElement;
  private readonly actionDown: HTMLButtonElement;
  ...
  private readonly onResizeHandler = (): void => this.refresh();
  ...
  constructor(
    ...
    actionRail.append(this.actionUp, this.actionSelect, this.actionDown);

    this.root.append(this.rotate, this.fire, this.fullscreen, this.movePad, this.lookPad, this.interact, actionRail);
