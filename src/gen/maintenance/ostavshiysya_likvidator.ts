...
const LOST_DEF: PlotNpcDef = {
  ...
  talkLines: [
    ...
    'После отбоя здесь остался не пост. Остался я и приказ, который уже не помнит мой номер.',
  ],
  talkLinesPost: [
...
const REPORTER_DEF: PlotNpcDef = {
  ...
  talkLines: [
    ...
    'Живой рапорт лучше мёртвого героя. Мёртвый герой обычно ещё и без патронов.',
  ],
  talkLinesPost: [
...
const MECHANIC_DEF: PlotNpcDef = {
  ...
  talkLines: [
    'Он не бандит. Бандит так ровно не перезаряжается. Найди жетон смены и дай ему вспомнить номер.',
    'За стойкой есть бетон. После выстрела у него длинная пауза: тогда можно говорить, а не геройствовать.',
  ],
  talkLinesPost: [
...
const KILL_OUTCOME: OutcomeEffect = {
  id: 'killed',
  message: 'Оставшегося Ликвидатора добили. Фильтр и дробь полезны, но караул теперь помнит цену этой добычи.',
  tags: ['kill', 'loot'],
  rumorIds: ['faction_liquidator_patrol'],
  privacy: 'witnessed',
  deltas: [
