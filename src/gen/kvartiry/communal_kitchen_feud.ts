...
const FEOFAN: PlotNpcDef = {
  ...
  talkLines: [
    'Ключ от кухни должен лежать у того, кто слышит кипяток, а не у того, кто считает порции.',
    'Рая прячет заёмный ключ в тумбе. Принесёшь - дверь будет слушать нас.',
    'Кража тише драки только до первого свидетеля.',
  ],
  talkLinesPost: [
    'Ключ перешёл к кастрюле. Теперь кастрюля говорит увереннее.',
    'Если Рая спросит, ключ ушёл на молитву.',
  ],
};
...
const WITNESS: PlotNpcDef = {
  ...
  talkLines: [
    ...
    'В газовом ящике Санька лежит поддельная пайковая карточка. Достанешь её - кухня поверит бумаге.',
