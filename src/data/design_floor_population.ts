...
const PLACEMENT_PROFILE_BUILDERS: Record<PlacementKind, PlacementProfileBuilder> = {
  'social': (base, actor, _target, _maxPerBucket) => {
    return {
        ...base,
  ...
  'floor_69': (base, actor, _target, _maxPerBucket) => {
    return {
        ...base,
  ...
  'communal': (base, actor, _target, _maxPerBucket) => {
    return {
        ...base,
        roomWeights: actor === 'npc'
          ? {
  ...
  'admin': (base, actor, _target, _maxPerBucket) => {
    return {
        ...base,
        roomWeights: actor === 'npc'
  ...
  'bank': (base, actor, _target, _maxPerBucket) => {
    return actor === 'npc'
        ? {
          ...base,
          noiseScale: 84,
  ...
  'industrial': (base, actor, _target, _maxPerBucket) => {
    return {
        ...base,
        roomWeights: actor === 'npc'
  ...
  'silicon': (base, actor, _target, _maxPerBucket) => {
    return {
        ...base,
  ...
  'slime': (base, actor, target, _maxPerBucket) => {
    return {
        ...base,
  ...
  'attic': (base, actor, target, _maxPerBucket) => {
  ...
  'hell': (base, actor, _target, _maxPerBucket) => {
    return {
        ...base,
  ...
  'underhell': (base, actor, target, _maxPerBucket) => {
    return {
        ...base,
  ...
  'void': (base, _actor, _target, _maxPerBucket) => {
    return {
        ...base,
        noiseScale: 160,
        noiseStrength: 0.08,
  ...
  'roof': (base, _actor, target, _maxPerBucket) => {
    return {
        ...base,
        noiseScale: 208,
        noiseStrength: 0.08,
  ...
  'camp': (base, actor, target, _maxPerBucket) => {
    return {
        ...base,
  ...
  'morgue': (base, actor, _target, _maxPerBucket) => {
    return {
        ...base,
  ...
  'crossroads': (base, actor, target, _maxPerBucket) => {
    return {
        ...base,
  ...
  'metro': (base, actor, target, maxPerBucket) => {
    return {
        ...base,
...
function placementProfile(kind: PlacementKind, actor: 'npc' | 'monster', target: number): DesignPlacementFieldProfile {
  ...
  const builder = PLACEMENT_PROFILE_BUILDERS[kind];
  if (builder) {
    return builder(base, actor, target, maxPerBucket);
  }
  return base;
}
