...
export const MONSTER_ECOLOGY: readonly MonsterEcologyDef[] = [
  ...
  },
  {
    ...
    counterplay: 'Еда в контейнере почти не пахнет: держите запас закрытым, бросайте приманку в сторону от маршрута и выжигайте или простреливайте узкий выход.',
  ...
  },
  {
    ...
    floorFit: 'Черные коллекторские лужи, насосные изгибы, пробные банки НИИ и мокрые обходы.',
    floors: [FloorLevel.MAINTENANCE],
  ...
  },
  {
    ...
    role: 'Hell spawner source that announces capped waves through a wet choir.',
    cue: 'Several child faces open one after another, the wall sings wetly, then small bodies drop near the source.',
    rule: 'Choir countdown spawns capped children; clearing the children opens a short damage window before the next verse.',
    floorFit: 'Flesh rooms, cult choir tax rooms, altar routes and deep organic Hell corridors.',
  ...
  },
  {
    ...
    minSamosborCount: 2,
    rare: true,
    lootHint: 'мокрая нервная слизь, карантинная карта, редкая ампула антибиотика из сорванного носителя',
