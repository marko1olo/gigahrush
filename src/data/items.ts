...
export const ITEMS: Record<string, ItemDef> = {
  ...
  bfg:       { id:'bfg',       name:'БФГ-9000',     type:ItemType.WEAPON,    desc:'Тяжёлый опытный ствол НИИ. Урон 210 по большой площади. Энергоячейки исчезают вместе с комнатой', spawnRooms:[], spawnW:0, value:11000 },
  ...
  veretar_sand:{ id:'veretar_sand', name:'Белый песок', type:ItemType.MISC, desc:'Сухой белый песок из Веретара. Не храните рядом с едой, фото и пропусками; гермопакет делает пробу безопаснее.', spawnRooms:[], spawnW:0, value:160, tags:['veretar','evidence','reagent','unsealed','contaminant'], stack:6 },
  sealed_veretar_sand:{ id:'sealed_veretar_sand', name:'Белый песок в гермопакете', type:ItemType.MISC, desc:'Запечатанная проба Веретара. Пакет не даёт песку сушить пайки и бумагу; Министерство и НИИ принимают как улику.', spawnRooms:[], spawnW:0, value:260, tags:['veretar','evidence','reagent','sealed','sample'], stack:3 },
  ...
  overexposed_photo:{ id:'overexposed_photo', name:'Засвеченный кадр', type:ItemType.MISC, desc:'Белое фото после Веретара. НИИ берёт как улику, как карта оно бесполезно.', spawnRooms:[], spawnW:0, value:140 },
