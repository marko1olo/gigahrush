...
const EVENT_TEXT_HANDLERS: Partial<Record<WorldEventType, (e: WorldEvent) => string>> = {
  samosbor_warning: (e) => {
  ...
  lift_arachna_avoided: (_) => {
      return 'Лифтовая арахна не упала. Шахта тиха.';
  },
  lift_arachna_cleared: (_) => {
