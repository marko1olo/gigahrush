...
export const DEF: MonsterDef = {
  ...
  counterplay: 'Рвите линию видимости и врывайтесь после выстрела: Параграф бьет до 15 клеток, но в упоре теряет главное преимущество.',
  lootHint: 'порванный приказ, сургучная пыль и живые формулировки',
};
