# Items 051: rb91_auto_shotgun

Status: single-item parallel worker plan, not shipped behavior. Created 2026-05-24.

Use this file as the complete brief for one GPT-5.5 subagent. That subagent owns only `rb91_auto_shotgun` and must not opportunistically implement neighboring items.
...
- Source plan row(s):
- items_2.md:101 (Liquidator weapons, ammo and combat roles)
...
| Field | Value |
| --- | --- |
| id | `rb91_auto_shotgun` |
| Russian name | РБ-91 |
| mode | new |
| intended type | WEAPON |
| gameplay role | Veteran semi-auto shotgun |
| reachability target | Rare HQ/black market |
| implementation note | High shell burn, strong recoil/spread. |
...
- src/data/item_packs/rb91_auto_shotgun.ts plus src/data/weapon_packs/rb91_auto_shotgun.ts for weapons
...
- Add or improve only `rb91_auto_shotgun`.
...
- Whether `rb91_auto_shotgun` was added, improved, merged into an existing id or rejected.
