# macro_49: Faction UI clarity pass
...
Make ownership, contested zones, and recent faction events scannable in canvas UI.
...
Draw from cached system/event state, keep labels stable and readable, and avoid world scans in draw calls.
