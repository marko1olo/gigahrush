# macro_97: Industrial and late route design floors
...
Make industrial and late route floors create pipeline, transfer, warning, and shortcut decisions.

## Направление

Design floors / industrial-late route
...
Connect production/service dependencies, dark metro ambush cues, underhell/darkness late warnings, and preserve FloorRun route state.
