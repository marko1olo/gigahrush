# macro_99: Procedural anomalies, lift instances, and connectivity guard
...
Improve anomaly/lift route interruptions and guard route-floor connectivity.

## Направление

Generation / route systems
...
- `src/data/floor_instances.ts`
- `src/systems/floor_instances.ts`
...
Add or tune one anomaly counterplay, one numbered-lift followup, and deterministic guards for spawn/lifts/POIs without new FloorLevel values.
