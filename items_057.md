# Items 057: g41_grenade_launcher

Status: single-item parallel worker plan, not shipped behavior. Created 2026-05-24.

Use this file as the complete brief for one GPT-5.5 subagent. That subagent owns only `g41_grenade_launcher` and must not opportunistically implement neighboring items.
...
- Source plan row(s):
- items_2.md:107 (Liquidator weapons, ammo and combat roles)
...
| Field | Value |
| --- | --- |
| id | `g41_grenade_launcher` |
| Russian name | 5Г41 станковый гранатомёт |
| mode | new |
| intended type | WEAPON |
| gameplay role | Mounted grenade launcher |
| reachability target | Authored route floor |
| implementation note | Stationary content, not generic loot. |
...
- src/data/item_packs/g41_grenade_launcher.ts plus src/data/weapon_packs/g41_grenade_launcher.ts for weapons
...
- Add or improve only `g41_grenade_launcher`.
...
- Whether `g41_grenade_launcher` was added, improved, merged into an existing id or rejected.
