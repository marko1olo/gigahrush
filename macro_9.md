# macro_9: Procedural texture and sprite atlas budget audit
...
Protect procedural sprite/texture density from atlas conflicts, blank frames, and hot-loop allocation.
...
Audit id ranges and generator allocation, fix duplicate or broken slots, add tests for changed ranges, and use no imported assets.
