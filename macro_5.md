# macro_5: Save/load normalization and stale state guard
...
Normalize or explicitly invalidate stale save state from recent systems.
...
Trace persisted state for world events, floor routes, numbered lifts, quest deadlines, inventory/equipment, money, and RPG stats; add guards without preserving broken early-development shapes forever.
