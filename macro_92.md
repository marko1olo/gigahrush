# macro_92: Void named-threat route coherence
...
Make Void named threats form readable late-game hazards with route clues.
...
- `src/gen/void/perestanovshchik.ts`
- `src/gen/void/seryy_smotritel.ts`
- `src/gen/void/maronary_signalshchik.ts`
- `src/gen/void/ekrannik.ts`
...
Fix broken refs first, then add clues, ordered risk, bypasses, or reward containers without global Void rewrites.
