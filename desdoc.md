...
- New agents can start from `README.md`, `desdoc.md`, `architecture.md`, root system docs and active reference folders, including `Docs/ScenarioWriters/`, without reopening archived AGXX logs.
