# macro_34: Quest UI expedition clarity
...
Make active objectives, target floor, deadline, and reward pressure easy to scan in canvas UI.
...
Use compact labels and stable layout, no DOM, and distinguish plot, side quest, and system assignment targets.
