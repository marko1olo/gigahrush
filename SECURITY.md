...
We actively maintain and provide security patches for the following versions of **marko1olo/gigahrush**:
...
Security audits for **marko1olo/gigahrush** focus on the following attack surfaces and failure modes:

1. **Memory Exhaustion**:  Malformed procedural map seeds triggering out-of-bounds array reads in DDA traverser.
2. **Audio Buffer Underflow**:  Web Audio node disconnection panics causing main-thread hangs.
3. **State Serialization Corruption**:  Malformed save payloads causing deserialization crashes.

---

## 🚨 3. Reporting a Vulnerability

If you discover a security vulnerability or exploit in **marko1olo/gigahrush**, please report it responsibly:
