# macro_81: Maintenance metro error transfer
...
Make metro error line a recoverable route anomaly with clues and return logic.
...
Add bounded transfer/wrong stop/safe return behavior without new FloorLevel or main.ts lift rewrites.
