# ГИГАХРУЩ: План Экономики

Дата: 2026-05-27
Статус: план фундаментального реворка экономики, лута, наград и численного прогресса. Часть фундамента уже внедрена; shipped facts отражаются в `README.md`. `balance.md` остается текущим баланс-контрактом, `alife.md` - контрактом постоянного населения, `ai.md` - контрактом активного AI.
