# macro_52: Living expedition prep hub polish
...
Strengthen the start hub as the place players prepare for expeditions.
...
Add or refine a loadout stash, checklist container, starter trade, contract board, or route lead reachable from spawn and protected by `aptMask` where needed.
