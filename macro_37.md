# macro_37: Scarcity reward caps and price pressure
...
Keep scarcity meaningful without runaway prices or rewards.
...
Audit formulas, add clamps/smoothing where needed, preserve access to critical survival items, and test bounds.
