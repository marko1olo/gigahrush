# macro_58: Living hermoseam repair expansion
...
Make hermoseam repair a concrete pre-samosbor preparation route.
...
Add local repair action consuming existing tools, with full/partial/failure outcomes bounded to one room/zone or one samosbor cycle.
