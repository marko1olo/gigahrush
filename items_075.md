# Items 075: ammo_12g_chemical

Status: single-item parallel worker plan, not shipped behavior. Created 2026-05-24.

Use this file as the complete brief for one GPT-5.5 subagent. That subagent owns only `ammo_12g_chemical` and must not opportunistically implement neighboring items.
...
- Source plan row(s):
- items_2.md:125 (Liquidator weapons, ammo and combat roles)
...
| Field | Value |
| --- | --- |
| id | `ammo_12g_chemical` |
| Russian name | Химический патрон 12 калибра |
| mode | new |
| intended type | AMMO |
| gameplay role | NII/liquidator special shell |
| reachability target | NII/HQ |
| implementation note | Needs generic effect first. |
...
- src/data/item_packs/ammo_12g_chemical.ts plus src/data/weapon_packs/ammo_12g_chemical.ts for weapons
...
- Add or improve only `ammo_12g_chemical`.
...
- Whether `ammo_12g_chemical` was added, improved, merged into an existing id or rejected.
