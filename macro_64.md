# macro_64: Ministry stamp room forgery risk
...
Make stamping/forgery useful with witness, audit, and failure risk.
...
Create or refine one forged output with a real use path in a gate/contract/trade and bounded local risk.
