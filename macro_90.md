# macro_90: Void protocol chamber rule clarity
...
Make protocol chamber teach one Void rule through play, not exposition.
...
Pick one rule and implement obey/break/pay/reroute/exploit choices with concise cues and events.
