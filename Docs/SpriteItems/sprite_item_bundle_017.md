...
items:
  - n: 145
    item_id: "fuel_issue_stamp"
    item_name_ru: "Штамп выдачи топлива"
    item_type: "MISC"
  ...
  - n: 146
    item_id: "fuse"
    item_name_ru: "Предохранитель"
    item_type: "MISC"
    source_item_file: "src/data/items.ts"
    visual_kind: "misc/story/trade"
    batch: "6_misc_story_trade"
  - n: 147
    item_id: "g41_grenade_launcher"
    item_name_ru: "5Г41 станковый гранатомёт"
    item_type: "WEAPON"
    source_item_file: "src/data/items.ts"
    visual_kind: "weapon"
    batch: "1_weapons_ammo"
  - n: 148
    item_id: "gas_sample_ampoule"
    item_name_ru: "Ампула газовой пробы"
    item_type: "MISC"
    source_item_file: "src/data/items.ts"
    visual_kind: "sample/anomaly"
    batch: "5_samples_anomalies"
  - n: 149
    item_id: "gasmask_filter"
    item_name_ru: "Фильтр противогаза"
    item_type: "MISC"
    source_item_file: "src/data/items.ts"
    visual_kind: "tool"
  ...
  - n: 151
    item_id: "gear"
    item_name_ru: "Шестерня"
    item_type: "MISC"
    source_item_file: "src/data/items.ts"
    visual_kind: "misc/story/trade"
    batch: "6_misc_story_trade"
  - n: 152
    item_id: "glass_ampoule_empty"
    item_name_ru: "Пустая ампула"
    item_type: "MISC"
    source_item_file: "src/data/items.ts"
...
# Sprite Item Bundle 017: 145-153

## Status

Complete. The bundle items are covered by procedural item sprites in `src/render/item_sprites.ts` and focused unit coverage in `tests/item-sprites.test.ts`.
...
- Source item plans: 145-153.
- Item count: 9.
- Batches covered: `4_documents_access`, `6_misc_story_trade`, `1_weapons_ammo`, `5_samples_anomalies`, `3_tools_repair_cleanup`, `2_consumables_medicine`.

## Included Items

| N | item_id | Russian name | Type | Visual need | Batch | Source |
| ---: | --- | --- | --- | --- | --- | --- |
| 145 | `fuel_issue_stamp` | Штамп выдачи топлива | `MISC` | document | 4_documents_access | src/data/documents_access.ts |
| 146 | `fuse` | Предохранитель | `MISC` | misc/story/trade | 6_misc_story_trade | src/data/items.ts |
| 147 | `g41_grenade_launcher` | 5Г41 станковый гранатомёт | `WEAPON` | weapon | 1_weapons_ammo | src/data/items.ts |
| 148 | `gas_sample_ampoule` | Ампула газовой пробы | `MISC` | sample/anomaly | 5_samples_anomalies | src/data/items.ts |
| 149 | `gasmask_filter` | Фильтр противогаза | `MISC` | tool | 3_tools_repair_cleanup | src/data/items.ts |
| 150 | `gauss` | Гаусс-винтовка | `WEAPON` | weapon | 1_weapons_ammo | src/data/items.ts |
| 151 | `gear` | Шестерня | `MISC` | misc/story/trade | 6_misc_story_trade | src/data/items.ts |
| 152 | `glass_ampoule_empty` | Пустая ампула | `MISC` | medicine | 2_consumables_medicine | src/data/items.ts |
| 153 | `glass_shard` | Стекло | `MISC` | misc/story/trade | 6_misc_story_trade | src/data/items.ts |
...
## Item 145: fuel_issue_stamp

Original metadata from deleted `sprite_item_145.md`:
...
Create a distinct procedural sprite/icon for `fuel_issue_stamp` (`Штамп выдачи топлива`) in the dirty survival-horror/post-Soviet GIGAHRUSH style. The player should understand the object family in about 0.2 seconds without reading the name.
...
- Read `Docs/SpriteItems/sprite_item_orchestrator.md`.
- Read this file.
- Inspect `src/data/documents_access.ts` and any system that references `fuel_issue_stamp`.
- Check `git status --short` and do not overwrite unrelated dirty work.

### Current Source Facts

- Item id: `fuel_issue_stamp`.
...
- Equip slot: `none`.
- Has use action: `no`.
- Tags: `document`, `fuel`, `liquidator`, `official`, `single_use`, `stamp`.
- Description: Масляный штамп на огневой запас. Один раз превращается в канистру бензина.
...
- [x] `fuel_issue_stamp` still exists in `ITEMS`.
...
Report changed files, visual rule chosen for `fuel_issue_stamp`, how it was inspected, and exact checks run.

---

## Item 146: fuse

Original metadata from deleted `sprite_item_146.md`:
...
Create a distinct procedural sprite/icon for `fuse` (`Предохранитель`) in the dirty survival-horror/post-Soviet GIGAHRUSH style. The player should understand the object family in about 0.2 seconds without reading the name.
...
- Read `Docs/SpriteItems/sprite_item_orchestrator.md`.
- Read this file.
- Inspect `src/data/items.ts` and any system that references `fuse`.
- Check `git status --short` and do not overwrite unrelated dirty work.

### Current Source Facts

- Item id: `fuse`.
- Russian name: `Предохранитель`.
- Type: `MISC`.
...
- Has use action: `no`.
- Tags: none.
- Description: Маленькая деталь между светом, терминалом и пожаром. Электрик берёт первым, спорит потом.
...
Report changed files, visual rule chosen for `fuse`, how it was inspected, and exact checks run.

---

## Item 147: g41_grenade_launcher

Original metadata from deleted `sprite_item_147.md`:
...
Create a distinct procedural sprite/icon for `g41_grenade_launcher` (`5Г41 станковый гранатомёт`) in the dirty survival-horror/post-Soviet GIGAHRUSH style. The player should understand the object family in about 0.2 seconds without reading the name.
...
- Read `Docs/SpriteItems/sprite_item_orchestrator.md`.
- Read this file.
- Inspect `src/data/items.ts` and any system that references `g41_grenade_launcher`.
- Check `git status --short` and do not overwrite unrelated dirty work.

### Current Source Facts

- Item id: `g41_grenade_launcher`.
...
- Equip slot: `weapon`.
- Has use action: `no`.
- Tags: `grenade`, `liquidator`, `mounted`, `production_belt`, `stationary`, `theft`, `weapon`.
- Description: Пломбированный станковый гранатомёт смены 14. Урон 125 по площади. Станок стоит на маршруте; украсть его можно, но каждая граната пишет ревизию.
...
- [x] `g41_grenade_launcher` still exists in `ITEMS`.
- [x] Russian name/description are not translated or accidentally changed.
...
Report changed files, visual rule chosen for `g41_grenade_launcher`, how it was inspected, and exact checks run.

---

## Item 148: gas_sample_ampoule

Original metadata from deleted `sprite_item_148.md`:
...
Create a distinct procedural sprite/icon for `gas_sample_ampoule` (`Ампула газовой пробы`) in the dirty survival-horror/post-Soviet GIGAHRUSH style. The player should understand the object family in about 0.2 seconds without reading the name.
...
- Read `Docs/SpriteItems/sprite_item_orchestrator.md`.
- Read this file.
- Inspect `src/data/items.ts` and any system that references `gas_sample_ampoule`.
- Check `git status --short` and do not overwrite unrelated dirty work.

### Current Source Facts

- Item id: `gas_sample_ampoule`.
...
- Equip slot: `none`.
- Has use action: `no`.
- Tags: `ampoule`, `evidence`, `gas`, `nii`, `sample`.
- Description: Запаянная ампула с зелёно-фиолетовой памятью самосбора. НИИ платит за целую, ликвидатор спрашивает, где был противогаз.
...
- [x] `gas_sample_ampoule` still exists in `ITEMS`.
- [x] Russian name/description are not translated or accidentally changed.
...
Report changed files, visual rule chosen for `gas_sample_ampoule`, how it was inspected, and exact checks run.

---

## Item 149: gasmask_filter

Original metadata from deleted `sprite_item_149.md`:
...
Create a distinct procedural sprite/icon for `gasmask_filter` (`Фильтр противогаза`) in the dirty survival-horror/post-Soviet GIGAHRUSH style. The player should understand the object family in about 0.2 seconds without reading the name.
...
- Read `Docs/SpriteItems/sprite_item_orchestrator.md`.
- Read this file.
- Inspect `src/data/items.ts` and any system that references `gasmask_filter`.
- Check `git status --short` and do not overwrite unrelated dirty work.

### Current Source Facts

- Item id: `gasmask_filter`.
...
- Equip slot: `none`.
- Has use action: `no`.
- Tags: `cleanup`, `filter`, `gasmask`, `liquidator`, `ppe`.
- Description: Сухой сменный фильтр. В смоге уходит в расход, от спор и борщевика бережёт горло. Сберечь для маршрута, сдать или продать.
...
- [x] `gasmask_filter` still exists in `ITEMS`.
- [x] Russian name/description are not translated or accidentally changed.
...
Report changed files, visual rule chosen for `gasmask_filter`, how it was inspected, and exact checks run.

---

## Item 150: gauss

Original metadata from deleted `sprite_item_150.md`:
...
Create a distinct procedural sprite/icon for `gauss` (`Гаусс-винтовка`) in the dirty survival-horror/post-Soviet GIGAHRUSH style. The player should understand the object family in about 0.2 seconds without reading the name.
...
- Read `Docs/SpriteItems/sprite_item_orchestrator.md`.
- Read this file.
- Inspect `src/data/items.ts` and any system that references `gauss`.
- Check `git status --short` and do not overwrite unrelated dirty work.

### Current Source Facts

- Item id: `gauss`.
- Russian name: `Гаусс-винтовка`.
- Type: `WEAPON`.
- Source file: `src/data/items.ts`.
- Value: `7200`.
- Spawn weight: `0`.
...
- Has use action: `no`.
- Tags: none.
- Description: Рельсотрон. Урон 150. Медленный точный выстрел за энергоячейку
...
Report changed files, visual rule chosen for `gauss`, how it was inspected, and exact checks run.

---

## Item 151: gear

Original metadata from deleted `sprite_item_151.md`:
...
Create a distinct procedural sprite/icon for `gear` (`Шестерня`) in the dirty survival-horror/post-Soviet GIGAHRUSH style. The player should understand the object family in about 0.2 seconds without reading the name.
...
- Read `Docs/SpriteItems/sprite_item_orchestrator.md`.
- Read this file.
- Inspect `src/data/items.ts` and any system that references `gear`.
- Check `git status --short` and do not overwrite unrelated dirty work.

### Current Source Facts

- Item id: `gear`.
- Russian name: `Шестерня`.
- Type: `MISC`.
- Source file: `src/data/items.ts`.
- Value: `9`.
- Spawn weight: `1`.
...
- Has use action: `no`.
- Tags: none.
- Description: Зубчатая мелочь для механизмов.
...
Report changed files, visual rule chosen for `gear`, how it was inspected, and exact checks run.

---

## Item 152: glass_ampoule_empty

Original metadata from deleted `sprite_item_152.md`:
...
Create a distinct procedural sprite/icon for `glass_ampoule_empty` (`Пустая ампула`) in the dirty survival-horror/post-Soviet GIGAHRUSH style. The player should understand the object family in about 0.2 seconds without reading the name.
...
- Read `Docs/SpriteItems/sprite_item_orchestrator.md`.
- Read this file.
- Inspect `src/data/items.ts` and any system that references `glass_ampoule_empty`.
- Check `git status --short` and do not overwrite unrelated dirty work.

### Current Source Facts

- Item id: `glass_ampoule_empty`.
...
- Equip slot: `none`.
- Has use action: `no`.
- Tags: `ampoule`, `component`, `medical`, `sampleware`, `trade`.
- Description: Тонкое стекло для лекарства, газа или беды в кармане. Пустая стоит мало, целая — уже подготовка.
...
- [x] `glass_ampoule_empty` still exists in `ITEMS`.
- [x] Russian name/description are not translated or accidentally changed.
...
Report changed files, visual rule chosen for `glass_ampoule_empty`, how it was inspected, and exact checks run.

---

## Item 153: glass_shard

Original metadata from deleted `sprite_item_153.md`:
...
Create a distinct procedural sprite/icon for `glass_shard` (`Стекло`) in the dirty survival-horror/post-Soviet GIGAHRUSH style. The player should understand the object family in about 0.2 seconds without reading the name.
...
- Read `Docs/SpriteItems/sprite_item_orchestrator.md`.
- Read this file.
- Inspect `src/data/items.ts` and any system that references `glass_shard`.
- Check `git status --short` and do not overwrite unrelated dirty work.
...
- Has use action: `no`.
- Tags: none.
- Description: Острый остаток окна, которого не было.
...
- [x] `glass_shard` still exists in `ITEMS`.
- [x] Russian name/description are not translated or accidentally changed.
- [x] Sprite is distinct from other `misc/story/trade` items.
- [x] 64x64 procedural sprite has transparent background and enough opaque pixels.
- [x] Item drop in world no longer appears as the generic yellow ball.
...
Report changed files, visual rule chosen for `glass_shard`, how it was inspected, and exact checks run.
