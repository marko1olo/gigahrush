# macro_44: Patrol and reinforcement performance caps
...
Keep patrols/reinforcements/clashes dramatic without entity or scan growth.
...
Inspect entity/zone/path loops, add caps/cooldowns/caches, and preserve behavior with targeted tests/build.
