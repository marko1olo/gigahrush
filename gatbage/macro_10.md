# macro_10: Canvas HUD and mobile clipping audit
...
Find and fix text clipping, overlap, and unreadable canvas HUD states on desktop and mobile.
...
Check inventory, quests, map, faction, stats, Net Sphere, container panels, and touch controls; use stable dimensions/wrapping and no DOM UI.
