# macro_70: Kvartiry barricade reroute encounter
...
Make barricades alter movement with repair, bribe, fight, or detour choices.
...
Do not seal the floor graph; add local bypass actions and map/log cues if supported.
