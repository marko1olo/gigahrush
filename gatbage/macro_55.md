# macro_55: Living temple shelter price
...
Make the temple an uneasy local shelter or ritual bargain around samosbor.
...
Add a temporary local warning/shelter/protected-container effect with real cost and failure case, never a global samosbor cancel.
