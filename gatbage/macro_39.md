# macro_39: Trade price and scarcity UI clarity
...
Make trade prices and scarcity pressure visible without a spreadsheet UI.
...
Expose read-only scarcity band if needed, draw compact item price/ownership/stolen/quest states, and check clipping.
