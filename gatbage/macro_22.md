# macro_22: Monster ecology rumor and screen hints
...
Ensure monster counterplay can be learned through rumors, screens, contracts, or NPC context.
...
Map each touched monster to ecology tags and at least one reachable hint path; do not add dead lore.
