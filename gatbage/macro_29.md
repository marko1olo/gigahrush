# macro_29: Samosbor director budget and telemetry
...
Keep director beats dramatic, bounded, inspectable, and cheap.

## Направление

Performance / horror cycle
...
Audit cadence/cooldowns/selection, add small debug telemetry if missing, and test duplicate/cooldown/event behavior where pure.
