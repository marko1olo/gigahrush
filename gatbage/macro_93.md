# macro_93: Void victory and return clarity
...
Make the Void return portal/victory state clear and bug-resistant.
...
Trace trigger conditions, prevent unrelated portal victory, preserve transition state, and add concise HUD/log/event feedback.
