# macro_78: Maintenance diver cache and water bridge route
...
Connect diver cache, water bridge, and wet hazards into a preparation-and-route choice.

## Направление

Floor content / Maintenance
...
- `src/gen/maintenance/diver_kot.ts`
...
Add gear-gated crossing, shortcut, container, contract item, or safer eel route using existing water mechanics.
