# macro_57: Living cartographer map debt
...
Make the cartographer room useful but costly for route planning.
...
Add paid/debt reveal for zone danger, route floor hint, contract target, or shelter mark; draw from existing map/route structures.
