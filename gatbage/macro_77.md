# macro_77: Maintenance steam valves timing puzzle
...
Make steam valves a timing/risk mechanic that opens routes or flushes threats.
...
Use room-local states, cooldowns, sound/HUD/log/marks, and no steam/fluid simulation.
