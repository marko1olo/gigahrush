# macro_42: NPC memory from events pass
...
Let NPCs react to observed facts without unbounded per-NPC memory.
...
Add capped handling for theft, samosbor, monster kills, contracts, and faction events, using existing context lines.
