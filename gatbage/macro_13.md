# macro_13: Projectile impact and audio feedback
...
Make player shots, enemy ranged attacks, PSI impacts, hits, and misses visually/audibly distinct.

## Направление

Systems / render feedback
...
Use procedural particles/sprites/sound, event-driven cues, and cooldowns; keep renderer read-only and avoid hot-loop allocation.
