# macro_33: Quest deadlines and failure edge cases
...
Make procedural assignment deadlines fair, visible, and robust across transitions.
...
- `architecture.md`
- `desdoc.md`
- `src/systems/quest_deadlines.ts`
...
Fix instant failures/invisible expiry, keep plot and most side quests non-expiring, and publish completion/failure events.
