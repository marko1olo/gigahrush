# macro_8: Unit test helpers cleanup
...
Make future focused tests cheaper to write without adding a new framework.
...
Identify repeated world/entity/item/quest setup, add tiny typed helpers only when reused by three or more tests, and migrate a few tests to prove value.
