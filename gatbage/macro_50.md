# macro_50: Cult procession counterplay refinement
...
Make cult processions readable and interactive: avoid, follow, report, disguise, or disrupt.

## Направление

A-Life / faction events
...
Verify each response path, cap pilgrims, add map/log cues, and test item/resource references.
