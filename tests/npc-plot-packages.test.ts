...
const MAIN_PLOT_IDS = [
  'cinematic_villain_prime',
  'cinematic_hero_prime',
  'marko_lolo',
  'liquidator_armorer',
  'liquidator_medic',
...
test('package-derived A-Life reserved identities keep package and plot identity linked', () => {
  const plan = buildAlifePopulationPlan({
    runSeed: 5,
    routeKeys: ['story:ministry', 'story:living', 'story:maintenance', 'story:hell', 'story:void', 'design:podad', 'design:liquidatorbase'],
