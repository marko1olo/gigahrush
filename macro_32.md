# macro_32: New expedition contract type pack
...
Add compact kill/retrieve/deliver/repair/TALK/VISIT contracts that are real expeditions.
...
Use existing items/NPCs/monsters/rooms, scarcity-aware rewards, concrete hints, and no dead target ids.
